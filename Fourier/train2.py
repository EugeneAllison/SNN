...
# from library.numpy.func_loader import Fourier
from library.numpy.func_loader import opto
from library.numpy.spiking_network import SpikingNetwork
...
parser.add_argument('--amp', type=float, default=1) #check approx
...
func = opto
# func = Fourier(dim=args.k, seed=args.seed)
